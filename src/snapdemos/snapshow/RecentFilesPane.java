...
public class RecentFilesPane extends ViewController {
    ...
    private static final WebURL DEFAULT_URL1 = WebURL.createUrl("https://reportmill.com/SlideShow/samples/Tutorial.md");
    private static final WebURL DEFAULT_URL2 = WebURL.createUrl("https://reportmill.com/SlideShow/samples/SamplePres.md");
